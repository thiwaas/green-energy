                    ...
                    <div className='bg-[#283046] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
                        ...
                        <form>
                            <div className='flex flex-col w-fu;; gap-1 mb-3'>
                                ...
                                <input className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d6d2]' type="text" id='name' name='category_name' placeholder='category name'/>
                            </div>
                            <div>
                            ...
                            <div>
                                <button className='bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-whit rounded-md px-7 py-2 my-2'>Add Category</button>
                            </div>
                        </form>  
                    </div>
                </div>
